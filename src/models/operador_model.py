...
class Operador:
  def __init__(self,nif_operador, razon_social, cob_fwa, cob_movil, nif_grupo_operador, grupo_operador, nif_replegal, nombre_replegal, nif_notificacion,
                 representante_notificacion, email_notificacion):
